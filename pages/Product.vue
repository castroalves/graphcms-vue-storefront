<template>
  <div id="product">
    <SfBreadcrumbs
      ...
      :breadcrumbs="productGetters.getBreadcrumbs(product)"
    />
    <div class="product">
...
export default {
  ...
  setup() {
    ...
    onSSR(async () => {
      ...
      const relatedProductTags = relatedProducts.value.map((prod) => {
      ...
      addTags(tags.concat(productTags, relatedProductTags, categoriesTags));
    });
