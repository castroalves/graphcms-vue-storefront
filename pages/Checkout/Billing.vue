...
import { useUserBilling, userBillingGetters, useUser, useBilling, useShipping } from '@vsf-enterprise/commercetools';
...
export default {
  ...
  setup(_, context) {
    ...
    const { billing: address, loading, load: loadBilling, save: saveBilling } = useBilling();
    ...
    const handleAddressSubmit = (reset) => async () => {
      ...
      await saveBilling({ billingDetails: billingDetails.value });
