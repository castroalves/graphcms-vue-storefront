<template>
  <div>
    ...
    />
    <SfAccordion
      :open="$t('Shipping address')"
      class="accordion smartphone-only"
    >
        ...
        <div class="accordion__item">
          <div class="accordion__content">
            <p class="content">
              ...
              {{ shippingDetails.streetNumber }}, {{ shippingDetails.zipCode
              }}<br />
          ...
          <div class="accordion__content">
            ...
            <template v-else>
              <p class="content">
                ...
                {{ billingDetails.streetNumber }}, {{ billingDetails.zipCode
                }}<br />
    ...
    <SfTable class="sf-table--bordered table desktop-only">
      ...
      >
        ...
        <SfTableData
          v-e2e="'product-title-sku'"
          class="table__data table__description table__data"
        >
      ...
      <div class="summary__group">
        <div class="summary__total">
          ...
          <SfProperty
            ...
            :value="
              $n(
                getShippingMethodPrice(chosenShippingMethod, totals.total),
                'currency',
              )
            "
            class="sf-property--full-width property"
